...
If you use snake_case for methods, use snake_case. If you prefer camelCase, use camelCase. If you like using the "get" prefix, that's great -- don't stray into "fetch" or "acquire" unless you have an *very* convincing use-case. 

Inconsistent conventions create an unnecessary cognitive burden on your readers; consistent conventions ease that burden.
...
Honestly, there isn't a universally-accepted measure of "small." Here are some statistics from statistics from a Ruby codebase written by Martin Fowler. Fowler is something thought-leader in software engineering theory, so one could do worse than emulating him.
...
Now those are some small functions!
